...
parameters  = {'visualFeatures':'Description, Categories, Brands',
'language':'en'}

# Open the image file to get a file object containing the image to analyze
image_path = "./TestImages/bull.jpeg"
...
#print(results['adult']['isAdultContent'])
#print(results ['description']['tags'][4])
